        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className={`col-span-1 md:col-span-2 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              Leading trading company specializing in high-quality electronic components, 
              devices, and power inverters for businesses worldwide.
            </p>
          ...
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{ transitionDelay: '200ms' }}>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#products" className="text-gray-300 hover:text-blue-400 transition-colors">Electronic Devices</a></li>
              <li><a href="#products" className="text-gray-300 hover:text-blue-400 transition-colors">Power Inverters</a></li>
              <li><a href="#products" className="text-gray-300 hover:text-blue-400 transition-colors">Testing Equipment</a></li>
            </ul>
          </div>
